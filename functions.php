 ...
 * VERSION 1.0.19 - Header & Mobile Hero Updates
 */
function bibledoc_scripts() {
    wp_enqueue_style( 'bibledoc-style', get_stylesheet_uri(), array(), '1.0.19' ); 
    wp_enqueue_script( 'bibledoc-script', get_template_directory_uri() . '/js/script.js', array(), '1.0.19', true );
